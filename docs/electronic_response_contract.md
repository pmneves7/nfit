...
| experimental projection | fitting, normalization, and cross-section services | momentum conversion, orbital-resolved spin projection, fluctuation--dissipation convention, bulk conversion, and explicit model-cell-to-dataset normalization |
