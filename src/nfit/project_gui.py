    ...
    *,
    ...
    if model.type == "tight_binding":
        ...
        if (
            ...
            set_tight_binding_standard_path(model, "hinuma")
...
class NfitProjectExplorer:
    ...
    def _build_tight_binding_editor(self, model: ModelComponentSpec) -> None:
        ...
        path_convention.setToolTip(
            "Choose a manually entered path or the HPKOT standard path from "
            "Hinuma et al., generated by Seek-path in nfit's primitive "
            "reciprocal basis."
        )
    ...
    def _build_tight_binding_hopping_editor(
        ...
        parameterization.setObjectName(
