...
from .fit_config_heisenberg_rpa import (
    _RpaComponentEvaluator as _RpaComponentEvaluator,
)
from .fit_config_heisenberg_rpa import (
    configure_fit_helpers as _configure_heisenberg_rpa_fit_helpers,
)
from .fitting import (
    DerivedParameter,
    FitDataset,
...
def _lindhard_factory(
    ...
    *,
    ...
    from .fit_config_electronic import configure_fit_helpers, lindhard_factory

    configure_fit_helpers(globals())

    return lindhard_factory(
        component,
        components,
...
_configure_heisenberg_rpa_fit_helpers(globals())
...
def _electronic_rpa_component_diagnostics(
    ...
    electronic_rpa_energy_scan = resolve_model_hook(
        "model_plots", "electronic_rpa_energy_scan"
    )
