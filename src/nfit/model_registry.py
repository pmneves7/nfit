...
from ._model_hooks import resolve_model_hook
...
def _fit_factory(name: str) -> ModelFactory:
    def factory(component: Any) -> Callable[..., Any]:
        return resolve_model_hook("fit_config", name)(component)
...
def _fit_context_factory(name: str) -> ContextModelFactory:
    def factory(
        ...
        return resolve_model_hook("fit_config", name)(component, components)
...
def _fit_dynamic_parameters(name: str) -> DynamicParameters:
    def parameters(component: Any) -> tuple[str, ...]:
        return tuple(resolve_model_hook("fit_config", name)(component))
...
def _fit_diagnostics(name: str) -> ModelDiagnostics:
    def diagnostics(
        ...
        return resolve_model_hook("fit_config", name)(component, data, params)
...
def _fit_context_diagnostics(name: str) -> ContextModelDiagnostics:
    def diagnostics(
        ...
        return resolve_model_hook("fit_config", name)(
            component, data, params, components
        )
...
def _fit_validator(name: str) -> ModelValidator:
    def validate(component: Any) -> None:
        resolve_model_hook("fit_config", name)(component)
...
def _report_sections(name: str) -> ModelReportSections:
    def sections(
        ...
        return resolve_model_hook("report", name)(
            fit_entry, model, goodness, context
        )
...
def _model_plot_calculator(name: str) -> Callable[..., Any]:
    def calculate(*args: Any, **kwargs: Any) -> Any:
        return resolve_model_hook("model_plots", name)(*args, **kwargs)
...
def _model_plot_script(name: str) -> Callable[..., str]:
    def script(*args: Any, **kwargs: Any) -> str:
        return str(resolve_model_hook("model_plots", name)(*args, **kwargs))
...
def _tight_binding_plot_script(plot_key: str) -> Callable[..., str]:
    def script(component: Any) -> str:
        script_provider = resolve_model_hook(
            "model_plots", "tight_binding_plot_script"
        )
        return script_provider(component, plot_key)
...
def _register_lindhard_model() -> None:
    from .model_registry_electronic import register_lindhard_model

    register_lindhard_model(globals())


def _register_electronic_rpa_models() -> None:
    from .model_registry_electronic import register_electronic_rpa_models

    register_electronic_rpa_models(globals())


def _register_tight_binding_model() -> None:
    from .model_registry_electronic import register_tight_binding_model

    register_tight_binding_model(globals())
